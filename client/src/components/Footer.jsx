    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-wrap md:text-left text-center order-first">
        <div class="lg:w-1/6 md:w-1/4 w-full px-4">
          <h2 class="title-font text-white tracking-widest text-2xl font-bold mb-8">Disease Prediction System</h2>
        ...
        <div class="lg:w-1/6 md:w-1/4 w-full px-4">
          <h2 class="title-font font-bold text-white tracking-widest text-lg mb-8">Spectra</h2>
          <nav class="list-none mb-10 space-y-4 font-normal">
            <li>
        ...
        <div class="lg:w-1/6 md:w-1/4 w-full px-4">
          <h2 class="title-font font-bold text-white tracking-widest text-lg mb-8">Contact</h2>
          <nav class="list-none mb-10 space-y-4 font-normal">
            <li>
